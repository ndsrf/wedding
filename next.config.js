...
const nextConfig = {
  ...
  serverExternalPackages: ['@exodus/bytes', 'pdf-parse', 'pdfjs-dist', '@napi-rs/canvas', 'twilio', 'sharp'],
  ...
  async headers() {
    ...
    const cspDirectives = [
      ...
      "frame-src 'self' https://accounts.google.com https://www.facebook.com https://www.google.com https://demo.arcade.software https://player.vimeo.com https://vimeo.com https://open.spotify.com",
