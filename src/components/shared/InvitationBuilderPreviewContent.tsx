/**
 * Shared Invitation Builder Preview Content
 *
 * Used by both the Admin (/admin/invitation-builder/preview) and Planner
 * (/planner/weddings/[id]/invitation-builder/preview) preview pages.
 * Reads design data from sessionStorage (set by the builder before opening
 * the preview window) and renders it with a language selector.
 *
    ...
    <div className="min-h-screen relative">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 py-2 flex justify-between items-center">
          <h1 className="text-sm font-medium text-gray-600">{weddingData.couple_names}</h1>
