      ...
      {channel === 'WHATSAPP' && (
        <div className="border border-purple-200 rounded-lg p-4 bg-purple-50">
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-3 gap-2">
              <div className="text-xs text-purple-800 font-mono">tastingParticipantName</div>
              <div className="text-xs text-purple-800 font-mono">{'{{10}}'}</div>
              <div className="text-xs text-purple-700">Tasting participant name</div>
            </div>
            <div className="grid grid-cols-3 gap-2">
              <div className="text-xs text-purple-800 font-mono">tastingLink</div>
              <div className="text-xs text-purple-800 font-mono">{'{{11}}'}</div>
              <div className="text-xs text-purple-700">Tasting menu link</div>
            </div>
          </div>
