/**
 * Wedding Planner - Guest WhatsApp Message Text API Route
 *
 * GET /api/planner/weddings/:id/guests/:guestId/whatsapp-text - Get the WhatsApp message text for a family
 */
