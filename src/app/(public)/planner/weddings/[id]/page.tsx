...
import { CurrencyIcon } from '@/components/shared/NavIcons';
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
            ...
            <NavGroup
              ...
              items={[
                ...
                {
                  href: `/planner/weddings/${weddingId}/payments`,
            ...
            {/* Configure */}
            <Link
              href={`/planner/weddings/${weddingId}/configure`}
              className="group flex items-center gap-4 bg-white rounded-xl border border-gray-100 shadow-sm p-4 hover:shadow-md hover:border-gray-200 hover:bg-gray-50/40 transition-all"
            >
              <div className="flex-shrink-0 w-12 h-12 bg-gray-50 rounded-xl flex items-center justify-center group-hover:bg-gray-100 transition-colors">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-500 mt-0.5 truncate">{t('admin.dashboard.configureSubtitle')}</p>
              </div>
              <svg className="h-4 w-4 text-gray-300 group-hover:text-gray-400 transition-colors flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
            </Link>
          </div>
