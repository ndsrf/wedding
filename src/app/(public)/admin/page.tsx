      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            <Link
              href="/admin/wizard"
              className="flex items-center p-4 border-2 border-purple-300 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg hover:border-purple-400 hover:shadow-md transition-all"
            >
              ...
              <div className="ml-4">
                <h3 className="text-sm font-medium text-purple-900">Setup Wizard</h3>
                <p className="mt-1 text-sm text-purple-700">Configure your wedding step by step</p>
              </div>
            </Link>
