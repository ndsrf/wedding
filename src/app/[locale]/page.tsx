      ...
      <section id="features" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Feature 7: Client Management */}
            <div className="p-8 rounded-2xl bg-gradient-to-br from-violet-50 to-purple-50 hover:shadow-xl transition-shadow border border-violet-100">
              <div className="w-14 h-14 rounded-full bg-gradient-to-r from-violet-500 to-purple-500 flex items-center justify-center mb-6">
                <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-3">
                {t('landing.features.items.clientManagement.title')}
              </h3>
              <p className="text-gray-600 leading-relaxed">
                {t('landing.features.items.clientManagement.description')}
              </p>
            </div>

            {/* Feature 8: Venue & Location Management */}
            <div className="p-8 rounded-2xl bg-gradient-to-br from-green-50 to-lime-50 hover:shadow-xl transition-shadow border border-green-100">
              <div className="w-14 h-14 rounded-full bg-gradient-to-r from-green-500 to-lime-500 flex items-center justify-center mb-6">
                <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">
                {t('landing.features.items.locations.title')}
              </h3>
              <p className="text-gray-600 leading-relaxed">
                {t('landing.features.items.locations.description')}
              </p>
            </div>

            {/* Feature 9: Quotes & Budgets */}
            <div className="p-8 rounded-2xl bg-gradient-to-br from-sky-50 to-blue-50 hover:shadow-xl transition-shadow border border-sky-100">
              <div className="w-14 h-14 rounded-full bg-gradient-to-r from-sky-500 to-blue-500 flex items-center justify-center mb-6">
                <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-3">
                {t('landing.features.items.quotesAndBudgets.title')}
              </h3>
              <p className="text-gray-600 leading-relaxed">
                {t('landing.features.items.quotesAndBudgets.description')}
              </p>
            </div>

            {/* Feature 10: Contracts & Digital Signature */}
            <div className="p-8 rounded-2xl bg-gradient-to-br from-slate-50 to-gray-50 hover:shadow-xl transition-shadow border border-slate-100">
              <div className="w-14 h-14 rounded-full bg-gradient-to-r from-slate-500 to-gray-500 flex items-center justify-center mb-6">
                <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-3">
                {t('landing.features.items.contractsSignature.title')}
              </h3>
              <p className="text-gray-600 leading-relaxed">
                {t('landing.features.items.contractsSignature.description')}
              </p>
            </div>

            {/* Feature 11: Invoices & Pending Payments */}
            <div className="p-8 rounded-2xl bg-gradient-to-br from-yellow-50 to-amber-50 hover:shadow-xl transition-shadow border border-yellow-100">
              <div className="w-14 h-14 rounded-full bg-gradient-to-r from-yellow-500 to-amber-500 flex items-center justify-center mb-6">
                <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-3">
                {t('landing.features.items.invoicesPayments.title')}
              </h3>
              <p className="text-gray-600 leading-relaxed">
                {t('landing.features.items.invoicesPayments.description')}
              </p>
            </div>

            {/* Feature 12: Menu Management & Tasting */}
            <div className="p-8 rounded-2xl bg-gradient-to-br from-orange-50 to-red-50 hover:shadow-xl transition-shadow border border-orange-100">
              <div className="w-14 h-14 rounded-full bg-gradient-to-r from-orange-500 to-red-500 flex items-center justify-center mb-6">
                <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-3">
                {t('landing.features.items.menuTasting.title')}
              </h3>
              <p className="text-gray-600 leading-relaxed">
                {t('landing.features.items.menuTasting.description')}
              </p>
            </div>
          </div>
        </div>
