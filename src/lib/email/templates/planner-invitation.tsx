...
const translations = {
  es: {
    ...
    cta: 'Para comenzar, haz clic en el botón de abajo para iniciar sesión con tu cuenta de Google, Facebook:',
  ...
  en: {
    ...
    cta: 'To get started, click the button below to sign in with your Google, Facebook account:',
  ...
  fr: {
    ...
    cta: 'Pour commencer, cliquez sur le bouton ci-dessous pour vous connecter avec votre compte Google, Facebook:',
  ...
  it: {
    ...
    cta: 'Per iniziare, clicca sul pulsante qui sotto per accedere con il tuo account Google, Facebook:',
  ...
  de: {
    ...
    cta: 'Um zu beginnen, klicken Sie auf die Schaltfläche unten, um sich mit Ihrem Google-, FacebookKonto anzumelden:',
